...
})({"js/nav.js":[function(require,module,exports) {
{
  ...
  var controller = {
    ...
    bindEventHub: function bindEventHub() {
      ...
      eventHub.on('changeTabBarColor', function (color) {
        var c = $(_this.view.el).find('ul').css('background-color', color);
      });
    },
    bindEvents: function bindEvents() {
      var _this2 = this;

      $('.container').find('#switchTab > li > a').on('click', function (e) {
        e.preventDefault();
    ...
    selectTab: function selectTab() {
      ...
      var currentTab = str.substring(2, str.length - 2) || 'my';
      $('.container').find('#' + currentTab).addClass('active').siblings('.active').removeClass('active');
      var index = $('#' + currentTab).index();
      $('#pages').css({
        'transform': "translateX(".concat(-index * 390, "px)")
      });
      var isPlaying = str.charAt(str.length - 1) === 'y' ? true : false;
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","js/nav.js"], null)
//# sourceMappingURL=/nav.8bf579d3.map