...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/foot.js":[function(require,module,exports) {
{
  var view = {
    el: '#currentSong',
  ...
  var controller = {
    ...
    bindEvents: function bindEvents() {
      $('#currentPlay').on('click', function (e) {
        beActive('#currentPause');
        $('#player').addClass('playing');
        window.eventHub.emit('playClick');
        e.stopPropagation();
      });
      $('#currentPause').on('click', function (e) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","js/foot.js"], null)
//# sourceMappingURL=/foot.a9b7f118.map