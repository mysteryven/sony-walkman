...
})({"js/theme.js":[function(require,module,exports) {
{
  ...
  var controller = {
    ...
    bindEvents: function bindEvents() {
      $(this.view.el).find('#topBarTheme > div').on('click', function (e) {
      ...
      $(this.view.el).find('#shell > div').on('click', function (e) {
        var bgColor = $(e.currentTarget).css('background-color');
        $(e.currentTarget).addClass('active').siblings('.active').removeClass('active');
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","js/theme.js"], null)
//# sourceMappingURL=/theme.df83bf8f.map